		...
		if ( file_exists( $robots_path ) ) {
			...
			return array(
				...
				'description'  => $has_disallow_all
					? __( 'A physical robots.txt file exists in the site root and contains a "Disallow: /" directive, which may be blocking search engine crawlers from indexing your site. Remove the physical file to let WordPress manage robots.txt dynamically, or update it intentionally.', 'thisismyurl-shadow' )
					: __( 'A physical robots.txt file exists in the site root. This file overrides the dynamic robots.txt generated by WordPress and any SEO plugins. Ensure its directives are intentional and up to date, or remove it to allow WordPress to manage crawl policies automatically.', 'thisismyurl-shadow' ),

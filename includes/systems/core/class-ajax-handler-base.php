...
/**
 * Provide the shared contract for Shadow AJAX and admin-post handlers.
 *
...
abstract class AJAX_Handler_Base {
	...
	/**
	 * Retrieve a Shadow by Christopher Ross option expected to be an array.
	 *
	...
	/**
	 * Verify an AJAX request against Shadow's standard security contract.
	 *
	 ...
	 *
	 * This exists because several Shadow by Christopher Ross admin screens submit structured data

 ...
 *
 * Enables Shadow's native comment/form rate-limiting feature by toggling the
...
class Treatment_Form_Rate_Limiting_Active extends Treatment_Base {
	...
	public static function undo(): array {
		...
		return [
			'success' => true,
			'message' => __( 'Form rate limiting disabled. Shadow by Christopher Ross will no longer throttle comment submissions. Consider installing Akismet or a CAPTCHA plugin for continued protection.', 'thisismyurl-shadow' ),
		];
	}
}

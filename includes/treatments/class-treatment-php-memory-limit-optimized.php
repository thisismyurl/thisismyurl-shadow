 ...
 * wraps the change in markers so Shadow by Christopher Ross can show a preview, apply it safely,
...
class Treatment_Php_Memory_Limit_Optimized extends Treatment_Base {
	 ...
	 * @var   string
	 */
	const DEFINE_BLOCK = "define( 'WP_MEMORY_LIMIT', '256M' );     // Shadow by Christopher Ross: front-end PHP memory cap\n" .
	                     "define( 'WP_MAX_MEMORY_LIMIT', '512M' ); // Shadow by Christopher Ross: admin/WP-Cron PHP memory cap";

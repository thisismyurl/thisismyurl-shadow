 ...
 *
 * Shadow by Christopher Ross does not move the file automatically because the new directory
...
STEP 5 — Re-run the Shadow by Christopher Ross scan to confirm this diagnostic is resolved.

 ...
 * are updated in place; otherwise Shadow by Christopher Ross inserts a marker-wrapped block.
 *
...
class Treatment_Trash_Auto_Empty_Configured extends Treatment_Base {
	...
	private const DEFINE_LINE   = "define( 'EMPTY_TRASH_DAYS', 30 ); // Shadow by Christopher Ross: keep trash cleanup enabled";
	...
	public static function get_sftp_undo_instructions(): string {
		...
		return implode( "\n", array(
			...
			"Either restore your previous wp-config.php from backup or remove the Shadow by Christopher Ross-added EMPTY_TRASH_DAYS change.",

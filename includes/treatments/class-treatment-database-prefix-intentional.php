 ...
 *
 * Shadow by Christopher Ross does not perform this operation automatically because a failed or
...
Re-run the Shadow by Christopher Ross scan after completing the prefix change.",
					'thisismyurl-shadow'
				),
				$current_prefix,
